...
public interface AuthorizationService extends KapuaService {
    ...
    /**
     * Returns if the user (the current logged user retrieved by thread context) is allowed to perform the notification identified by provided the permission.
     *
    ...
    /**
     * Checks if the user (the current logged user retrieved by thread context) is allowed to perform the notification identified by provided the permission.
     *
     * @param permission The permission to check.
