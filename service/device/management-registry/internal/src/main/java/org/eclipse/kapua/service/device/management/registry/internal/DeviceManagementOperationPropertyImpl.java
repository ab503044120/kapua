 ...
 *******************************************************************************/
package org.eclipse.kapua.service.device.management.registry.internal;
...
public class DeviceManagementOperationPropertyImpl implements DeviceManagementOperationProperty {
    ...
    public static DeviceManagementOperationPropertyImpl parse(DeviceManagementOperationProperty jobStepProperty) {
        return jobStepProperty != null ? (jobStepProperty instanceof DeviceManagementOperationPropertyImpl ? (DeviceManagementOperationPropertyImpl) jobStepProperty : new DeviceManagementOperationPropertyImpl(jobStepProperty)) : null;
    }
}
